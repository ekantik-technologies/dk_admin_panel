...
export default function ComponentModel(props) {
    ...
    const updateComponent = async (data) => {
        try {
            ...
            const response = await API.put(`/inventory/packaging/components/${selectedComponentDetails._id}`, body);
    ...
    const createComponent = async (data) => {
        ...
        try {
            const response = await API.post("/inventory/packaging/components", body);
