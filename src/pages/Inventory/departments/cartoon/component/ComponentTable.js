...
import { EDIT_COMPONENT } from "../../../../../constants/modelConstant.js";
import UpdateQuantity from "../../../component/UpdateQuantity.js";
                    ...
                    {componentList?.length > 0 ? (
                        componentList.map((el, index) => (
                            <tr key={index} className="border-b hover:bg-gray-50">
                                ...
                                <td className="py-2 px-4 text-gray-800">
                                    <UpdateQuantity department="cartoon" {...el} fetchComponentList={fetchComponentList} />
                                </td>
                            </tr>
                        ))
                    ) : (
